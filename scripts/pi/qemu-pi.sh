...
#IMG="/mnt/d/www/SRTrpiPlayer/SRTrpiPlayer_v1.0.3.img"
IMG="../../fuck/test.img"
#IMG="/mnt/d/www/players/pi/images/2022-01-28-raspios-bullseye-armhf-lite.img"
#KERNEL=kernel-qemu-4.4.34-jessie
#KERNEL="/mnt/d/www/players/pi/kernel/kernel-qemu-5.10.63-bullseye"
KERNEL="../../fuck/kernel8.img"
#DTB="/mnt/d/www/players/pi/kernel/versatile-pb-bullseye-5.10.63.dtb"
DTB="../../fuck/bcm2710-rpi-3-b-plus.dtb"
...
#PARAMS_KERNEL="root=/dev/sda2 panic=1 rootfstype=ext4 rw init=/bin/sh"
#PARAMS_KERNEL="root=/dev/sda2 panic=1 rootfstype=ext4 rw"
#PARAMS_KERNEL="root=/dev/sda2 panic=1"
PARAMS_KERNEL="root=/dev/mmcblk0p2 rw rootwait panic=1 rootfstype=ext4"
...
#NET_ARGS="-netdev user,id=net0 -device vmxnet3,netdev=net0,id=net0,mac=$MAC"
#qemu-system-arm -kernel $KERNEL -dtb $DTB -cpu arm1176 -m 256 -M versatilepb $NET_ARGS \
#qemu-system-aarch64 -kernel $KERNEL -dtb $DTB -cpu arm1176 -m 256 -M versatilepb $NET_ARGS \
qemu-system-aarch64 -kernel $KERNEL -dtb $DTB -cpu arm1176 -m 1024 -M raspi3b $NET_ARGS \
