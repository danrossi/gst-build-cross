% gstreamer(SECTION) | User Commands
%
% "August 13 2024"
...
gstreamer - program to do something

# SYNOPSIS

**gstreamer** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**gstreamer** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **gstreamer** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**gstreamer** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    gstreamer. See **foo.conf**(5) for further details.
...
**gstreamer** provides some return codes, that can be used in scripts:
